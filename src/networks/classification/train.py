...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='models/lunar/classify/')
    parser.add_argument('--train_config', type=str, default='src/networks/classification/train.config')
    parser.add_argument('--network_file', type=str, default='src/networks/classification/layers.json')
    ...
    test_loader = setup_loader(args.train_data, batch_size=batch_size_test, val=True)
